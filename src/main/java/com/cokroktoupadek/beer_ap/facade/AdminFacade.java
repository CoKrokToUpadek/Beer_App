...
import com.cokroktoupadek.beer_ap.mapper.BeerEntityFilter;
...
public class AdminFacade {
    ...
    public BeerEntityFilter beerEntityFilter;
    @Autowired
    public AdminFacade(BeerDbService beerDbService, BeerMapper beerMapper, BeerClient beerClient, BeerEntityFilter beerEntityFilter) {
    ...
    public String updateDbFacade(){
        ...
        for (BeerEntity beerEntity:beerEntities){
            beerEntityFilter.beerEntityDuplicateCleanup(beerEntity);
