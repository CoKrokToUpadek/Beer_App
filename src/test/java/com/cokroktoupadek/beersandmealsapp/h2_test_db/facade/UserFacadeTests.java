package com.cokroktoupadek.beersandmealsapp.h2_test_db.facade;
...
public class UserFacadeTests {
    ...
    void testGetBeerListThrowsException()  {
        ...
        //then
        Assertions.assertEquals("class com.cokroktoupadek.beersandmealsapp.errorhandlers.BeerDbIsEmptyException",exception.getClass().toString());
    }
    ...
    void testGetMealListThrowsException()  {
        ...
        //then
        Assertions.assertEquals("class com.cokroktoupadek.beersandmealsapp.errorhandlers.MealDbIsEmptyException",exception.getClass().toString());
    }
